...
import com.mireaKR.coworking.service.YandexS3Service;
...
public class RoomService implements IRoomService {
    ...
    @Autowired
    private  YandexS3Service awsS3Service;
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            String imageUrl = awsS3Service.uploadFile(photo);
            Room room = new Room();
            ...
            response.setMessage("Ошибка при сохранении пространства " + e.getMessage());
        }
        return response;
    }
    ...
    public Response getAllRooms() {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Ошибка при сохранении пространсва " + e.getMessage());
        }
        return response;
    }
    ...
    public Response updateRoom(Long roomId, String description, String roomType, BigDecimal roomPrice, MultipartFile photo) {
        ...
        try {
            ...
            if (photo != null && !photo.isEmpty()) {
                imageUrl = awsS3Service.uploadFile(photo);
            }
            ...
            response.setStatusCode(500);
            response.setMessage("Ошибка сохранения пространства " + e.getMessage());
        }
        return response;
    }
