package com.mireaKR.coworking.utils;

import com.mireaKR.coworking.dto.BookingDTO;
import com.mireaKR.coworking.dto.RoomDTO;
...
public class Utils {
    ...
    public static BookingDTO mapBookingEntityToBookingDTO(Booking booking) {
        ...
        bookingDTO.setCheckInDate(booking.getCheckInDate());  // LocalDateTime
        bookingDTO.setCheckOutDate(booking.getCheckOutDate());  // LocalDateTime
