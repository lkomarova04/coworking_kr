  ...
  useEffect(() => {
    const fetchRoomTypes = async () => {
      try {
        ...
        console.error('Ошибка при выборе типов пространства:', error.message);
      }
    };
    fetchRoomTypes();
  }, []);
    ...
    try {
      ...
      if (response.statusCode === 200) {
        if (response.roomList.length === 0) {
          showError('Коворкинг в данный момент недоступен для этого диапазона дат в выбранном типе.');
          return
        }
      ...
      showError("Неизвестная ошибка: " + error.response.data.message);
    }
  };
